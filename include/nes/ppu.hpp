...
{
    class PPU;
    class ROM; // Forward declare our new Cartridge/ROM class
    ...
    public:
        ...
        // Pointer to the inserted cartridge. The PPU will ask the ROM to handle 
        // reads/writes in the $0000-$1FFF range and ask for the mirroring mode.
